...
class GameViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // create a new scene
        let scene = SCNScene(named: "sphere6.obj")!
        ...
        material?.diffuse.contents = UIImage(named: "Player_Albedo.png")
        material?.roughness.contents = UIImage(named: "Player_Roughness3.png")
        material?.metalness.contents = UIImage(named: "Player_Metal.png")
        material?.normal.contents = UIImage(named: "Player_Normal.png")
        material?.ambientOcclusion.contents = UIImage(named: "Player_AO.png")
